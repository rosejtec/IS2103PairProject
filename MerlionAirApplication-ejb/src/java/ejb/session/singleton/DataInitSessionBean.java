...
public class DataInitSessionBean {
    ...
    private void initializeData() {
        ...
        ate = new AircraftTypeEntity("Boeing 747", 400);
        em.persist(ate);
        em.flush();
        ...
        try {
            aircraftConfigurationSessionBean.createNewAircraftConfiguration(ac, cc, 1L);
        ...
        ac = new AircraftConfigurationEntity("Boeing 737 All Economy", 3, 180);
        cc = new ArrayList<>();
        cc.add(new CabinClassConfigurationEntity(CabinClassType.F, 1, 5, 2, "1-1", 10));
        cc.add(new CabinClassConfigurationEntity(CabinClassType.F, 1, 5, 4, "2-2", 20));
        ...
        ac = new AircraftConfigurationEntity("Boeing 747 All Economy", 1, 380);
        cc = new ArrayList<>();
        cc.add(new CabinClassConfigurationEntity(CabinClassType.F, 1, 5, 2, "1-1", 10));
        ...
        try {
            FlightEntity f = new FlightEntity("MA111", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(1L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            FlightEntity f2 = new FlightEntity("MA112", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(2L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
        ...
        try {
            FlightEntity f = new FlightEntity("ML211", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(3L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            FlightEntity f2 = new FlightEntity("ML212", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(4L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
        ...
        try {
            FlightEntity f = new FlightEntity("ML311", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(5L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(4L));
            FlightEntity f2 = new FlightEntity("ML312", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(6L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(4L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
            flightSessionBean.createNewFlight(f2);
        ...
        try {
            FlightEntity f = new FlightEntity("ML411", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(7L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            FlightEntity f2 = new FlightEntity("ML412", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(8L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
            flightSessionBean.createNewFlight(f2);
        ...
        try {
            FlightEntity f = new FlightEntity("ML511", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(9L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            FlightEntity f2 = new FlightEntity("ML512", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(10L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
            flightSessionBean.createNewFlight(f2);
        ...
        try {
            FlightEntity f = new FlightEntity("ML611", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(11L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            FlightEntity f2 = new FlightEntity("ML612", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(12L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
            flightSessionBean.createNewFlight(f2);
        ...
        try {
            FlightEntity f = new FlightEntity("ML621", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(11L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            FlightEntity f2 = new FlightEntity("ML622", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(12L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(2L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
            flightSessionBean.createNewFlight(f2);
        ...
        try {
            FlightEntity f = new FlightEntity("ML711", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(13L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(4L));
            FlightEntity f2 = new FlightEntity("ML712", flightRouteSessionBean.retrieveFlightRouteByFlightRouteId(14L), aircraftConfigurationSessionBean.retrieveAircraftConfigurationByAircraftConfigurationId(4L));
            f2.setComplementary(true);
            f = flightSessionBean.createNewFlight(f);
            f.setComplentaryFlight(f2);
            flightSessionBean.createNewFlight(f2);
        ...
        FlightEntity complementaryFlight = flightSessionBean.retrieveFlightByFlightNumber(flight.getComplentaryFlight().getFlightNumber());
        ...
        FlightEntity complementaryFlight = flightSessionBean.retrieveFlightByFlightNumber(flight.getComplentaryFlight().getFlightNumber());
          ...
          try{
            FlightSchedulePlanEntity fsp = new FlightSchedulePlanEntity(flightSessionBean.retrieveFlightByFlightNumber("ML411"), ScheduleEnum.RECURRENTWEEK);
            List<FlightScheduleEntity> flightScheduleList = new ArrayList<FlightScheduleEntity>();
